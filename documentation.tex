...
\usepackage{booktabs}
\usepackage{multirow}  % to merge cells in a table: provides \multirow, \multicolumn

% to use urls in text and captions
...
% Title Page
\title{Documentation File\\for the\\Bangor \textit{Siarad} Corpus\vspace{7cm}}
...
\begin{enumerate}
\item We transcribe some non-standard verb-noun suffixes, e.g. ‘-ian’ in ‘swnian’ (to grumble) rather than ‘-io’ in the standard form ‘swnio’. We also transcribe non-standard plural forms of nouns, e.g. \textbf{‘cobenni’} (night-dresses) rather than the standard form ‘cobannau’.
